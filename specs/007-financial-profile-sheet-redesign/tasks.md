...
- [ ] T009 Run `pnpm lint` and `pnpm build` from the `web/` directory; fix any TypeScript type errors, ESLint violations, or build failures introduced by the changes to `web/components/financial-profile-sheet.tsx`
